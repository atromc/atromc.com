...
const config = {
    serverInfo: {
        ...
        serverIp: "play.atromc.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "Astronauta",  <--- In-Game name
            rank: "Owner",  <-- rank
    ...
    */
    ...
    adminTeamPage: {
        Founder: [
            {
                inGameName: "𝓕𝓻𝓪𝓷𝓷",
                rank: "Founder",
                skinUrlOrPathToFile: "images/fran.png",
                rankColor: "black"
            },
            {
                inGameName: "𝓕𝓮𝓻𝓭𝓲",
                rank: "Founder",
                skinUrlOrPathToFile: "images/ferdi.png",
                rankColor: "black"
            },
            {
                inGameName: "𝓕𝓪𝓩𝓮",
                rank: "Founder",
                skinUrlOrPathToFile: "images/faze.png",
                rankColor: "black"
            },
            {
                inGameName: "𝓑𝓵4𝓬𝓚",
                rank: "Founder",
                skinUrlOrPathToFile: "images/nero.png",
                rankColor: "black"
            }
        ],
        COFounder: [
        ...
        SrAdmin: [
            {
                inGameName: "𝓖𝓱𝔁𝓼𝓽𝓮𝓭",
                rank: "SrAdmin",
                skinUrlOrPathToFile: "images/Ghxsted.png",
                rankColor: "red"
            }     
        ],
        SrDev: [
        ...
        SrMod: [
            {
                inGameName: "𝓢𝓪𝓷𝓭𝔂",
                rank: "Sr.Mod",
                skinUrlOrPathToFile: "images/gaydilivello2.png",
                rankColor: "darkblue"
            },
            {
                inGameName: "",
        ...
        Mod: [
            {
                inGameName: "𝔂𝓪𝓼𝓼𝓮𝓻_𝓼𝓽𝓸𝓷𝓴𝓼",
                rank: "Mod",
                skinUrlOrPathToFile: "images/yasser.png",
                rankColor: "violet"
            },
            {
                inGameName: "",
        ...
        SrHelper: [
            {
                inGameName: "𝓐𝓵𝓮𝔁",
                rank: "SrHelper",
                skinUrlOrPathToFile: "images/alex..png",
                rankColor: "darkgreen"
            },
            {
                inGameName: "𝓻𝓮𝓭𝓮★",
                rank: "SrHelper",
                skinUrlOrPathToFile: "images/trans.png",
                rankColor: "darkgreen"
            },
            {
                inGameName: "",
        ...
        helpers: [
            {
                ...
                rank: "Helper",
                skinUrlOrPathToFile: "images/ph.png",
                rankColor: "Green"
            },
            {
                inGameName: "𝓕𝓲𝓵𝓲𝓫𝓮𝓻𝓽𝓸",
                rank: "Helper",
                skinUrlOrPathToFile: "images/gay.png",
                rankColor: "Green"
            },
            {
                inGameName: "",
